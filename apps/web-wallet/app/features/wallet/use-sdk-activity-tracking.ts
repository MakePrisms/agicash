import type { StoreSdk } from '@agicash/wallet-sdk/store';
import { useEffect } from 'react';

/** Always present on the store engine (injected at construction). */
type Background = NonNullable<StoreSdk['background']>;
