import { type StoreSdk, createStoreSdk } from '@agicash/wallet-sdk/store';
...
let sdkPromise: Promise<StoreSdk> | undefined;
let sdkInstance: StoreSdk | undefined;
 ...
 */
export function initSdk(domain: string): Promise<StoreSdk> {
  if (!sdkPromise) {
 ...
 */
export function getSdk(): StoreSdk {
  if (!sdkInstance) {
