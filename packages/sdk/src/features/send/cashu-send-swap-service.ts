...
/**
 * Minimal interface for the receive swap service dependency.
 * The full CashuReceiveSwapService lives in the web layer.
 */
export type CashuReceiveSwapServiceLike = {
  create(params: {
...
export class CashuSendSwapService {
  constructor(
    ...
    private readonly cashuReceiveSwapService: CashuReceiveSwapServiceLike,
  ) {}
