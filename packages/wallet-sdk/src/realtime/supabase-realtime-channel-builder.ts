...
export class RealtimeChannelBuilder {
  ...
  // These on overloads were based on the ones from @supabase/supabase-js RealtimeChannel
  on(
  ...
  // biome-ignore lint/correctness/noUnusedVariables: this was copied from @supabase/supabase-js
  on<T extends { [key: string]: unknown }>(
    type: `${REALTIME_LISTEN_TYPES.SYSTEM}`,
    // biome-ignore lint/complexity/noBannedTypes: this was copied from @supabase/supabase-js
    filter: {},
