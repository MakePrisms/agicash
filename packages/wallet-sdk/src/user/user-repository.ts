...
export class WriteUserRepository {
   ...
   * @returns The upserted user and their accounts.
   */
  async upsert(
    user: {
      ...
      /** Email verified flag for the user to insert or new value to update for existing user. */
...
export class ReadUserDefaultAccountRepository {
  ...
  async getDefaultAccount(
    ...
    const account = data.accounts.find(
      (a: AgicashDbAccount) => a.id === defaultAccountId,
    );
