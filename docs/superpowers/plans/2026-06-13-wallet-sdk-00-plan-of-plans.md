...
| 15 | S15 | cleanup (delete dead web lib copies, drop unused deps; deferred B1–B6 fixes) | 📝 [planned](2026-06-22-wallet-sdk-15-cleanup.md) (14 tasks; NOT executed) — re-grep on today's tree (`project-wallet-sdk-s15-grounding`) found most spec-§7 substrate ALIVE (token-claim route + tx-detail + feature-flags never flipped to sdk.*); only ~13 whole files + ~10 named-exports + 1 dep dead. biome already done early (`015a8aaa`) |
